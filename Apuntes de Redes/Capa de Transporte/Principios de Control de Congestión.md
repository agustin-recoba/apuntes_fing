...
Sabremos que existe congestión en la red si tenemos una pérdida de paquetes (buffer overflow en los routers) ó grandes retardos (encolamiento en los buffers de los routers).
